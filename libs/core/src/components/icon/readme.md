...
| `color`     | `color`     | Optional property that defines the background color of the button. The default color will be inherited from its parent.                                                                                                                  | `"alternative" \| "error" \| "information" \| "none" \| "primary" \| "secondary" \| "standard" \| "success" \| "warning"` | `undefined` |
...
| `noHover`   | `no-hover`  | Optional property that disables the hover background (only if option property is set to button)                                                                                                                                          | `boolean`                                                                                                                 | `false`     |
