    ...
    return `
        <se-table>
            ...
            <se-table-group selectable="true">
                ...
                <se-table-item width="64px"><se-checkbox style="margin-right:-8px;display:inline-block;"></se-checkbox></se-table-item>
            ...
            <se-table-group selectable="true" selected=${selected}>
                <se-table-item width="72px"><se-icon option="button" disabled="true">arrow2_down</se-icon></se-table-item>
                <se-table-item width="64px"><se-checkbox selected=${selected}></se-checkbox></se-table-item>
