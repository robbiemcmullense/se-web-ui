...
| `color`       | `color`        | <span style="color:red">**[DEPRECATED]**</span> use the configuration directly on se-dialog-header<br/><br/>Defines the color of the dialog header. `alternative`: Alternative background with primary color for the text `primary`: Primary color schema and default setting. | `"alternative" \| "primary"`                           | `'primary'` |
