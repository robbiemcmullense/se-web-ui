...
| `labelRequired` | `label-required` | Defines the text value of the text that will be seen if the user mouse hover a required field. Used for translation purpose.                                                                                                                                                                                                                               | `string`                                       | `'required'` |
