...
| `pageScroll` | `page-scroll` | Define if the content of the page should scroll with the header (useful on website context). The header can then have the style sticky to stay in the top of the page if needed.                                                                                  | `boolean`                           | `undefined`   |
