...
| ------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------- | ---------- |
| `alignment`         | `alignment`          | Defines how to align the dropdown container. `end`: Position the container with respect to the end side (right) of the trigger element. `start`: Position the container with respect to the right side of the trigger element. `right` (deprecated): Position the container with respect to the right side of the trigger element. `left` (deprecated): Position the container with respect to the left side of the trigger element. | `"end" \| "left" \| "right" \| "start"` | `'start'`  |
