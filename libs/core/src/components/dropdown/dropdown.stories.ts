...
storiesOf('Dropdown', module)
  .add('Dropdown Button', () => {
    ...
    return `
      <div style="margin-left: 40%;">
        <se-dropdown id="button-dropdown" alignment="${alignment}" max-width="${maxWidth}px" max-height="${maxHeight}px">
  ...
  .add('Dropdown Icon', () => {
    ...
    return `
      <div style="margin-left: 40%;">
        <se-dropdown id="icon-dropdown" alignment="${alignment}" max-width="${maxWidth}px" max-height="${maxHeight}px">
