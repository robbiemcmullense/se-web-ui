...
| `maxWidth`  | `max-width` | Defines the  max-width of a column.                                                                                                                                                                                                                                                                    | `string`                    | `undefined` |
...
| `resizable` | `resizable` | Optional property defines whether the column is resizable or not. Default value `false` defines column as not resizable `true` defines column is resizable                                                                                                                                             | `boolean`                   | `undefined` |
...
| ---------------- | ------------------------------------------------------------------------------------ | ------------------- |
| `didWidthChange` | Event emitted to notify the table-group-header component that the width has changed. | `CustomEvent<void>` |
