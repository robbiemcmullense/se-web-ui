...
| `type`     | `type`     | Default setting is `internal`. Set to `external` adds an underline to the link, and opens the link in a new web browser tab. | `"external" \| "internal"` | `'internal'` |
