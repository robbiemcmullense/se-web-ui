...
| ----------- | ------------ | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | --------------- |
| `canClose`  | `can-close`  | Display a close "button".                                                                                                 | `boolean`                                            | `undefined`     |
| `closeText` | `close-text` | Defines the text you want your "close button" to read.                                                                    | `string`                                             | `undefined`     |
| `icon`      | `icon`       | The name of the icon you wish to display.  Optional.                                                                      | `string`                                             | `undefined`     |
...
| ------- | ------------------------------------------------------------------- | ------------------- |
| `close` | Send information to the parent component when closing the snackbar. | `CustomEvent<void>` |
