 ...
 describe('ListComponent', () => {
  ...
  it('renders', async() => {	
	...
	it('renders a list item with its title and description', async() => {
		...
		await page.setContent('<se-list><se-list-item item-title="list title" description="my description"></se-list-item></se-list>');
	...
	it('renders a list group', async() => {
		const groupHTML = '<se-list-item class="classic hydrated" item-title="group title"></se-list-item><div class="group-item"><slot></slot></div>';

		await page.setContent('<se-list><se-list-group item-title="group title"></se-list-group></se-list>');
