  ...
  <se-container>
    <se-widget width="250px" option="fill">
      <se-list>
        ...
        <se-list-item item="Basic Item" icon="action_settings2"> </se-list-item>
        <se-list-group
        ...
        >
          ...
          <se-list-group item="simple collapse">
            ...
            <se-list-item item="Basic Item" selected="true"> </se-list-item>
          </se-list-group>
        </se-list-group>
        <se-list-group item="simple collapse">
          <se-list-item item="No icon, not selected" selected="false">
    ...
    >
        ...
        <se-widget-header>
          ...
          <div slot="end">
            <se-dropdown alignment="right">
              <se-icon slot="trigger" option="button" color="alternative"
                >other_vertical</se-icon
              >
            ...
            <se-icon option="button" color="alternative" onclick="toggle(0)"
      ...
      <se-widget id="widget1">
        ...
        <se-widget-content>
          ...
          <se-button option="outline" onclick="loader()">Outline</se-button>
          ...
          <se-chip value="Chip 02" can-close="false" color="primary"></se-chip>
          <se-link url="http://google.com">Link to Google</se-link>
          <se-link url="http://google.com" type="external"
            >External Link to Google</se-link
          >
          <se-link url="http://google.com" disabled="true"
            >Link to Google</se-link
          >
          <se-link url="http://google.com" type="external" disabled="true"
            >External Link to Google</se-link
          >
          <se-button option="flat">Flat</se-button>
          <se-button option="flat" color="primary">FlatGreen</se-button>
          <se-button id="raisedBtn" option="raised">Raised</se-button>
          <se-button id="raisedBtn2" option="raised" color="primary"
            >RaisedGreen</se-button
          >
          <se-button id="textBtn1" option="text">Text</se-button>
          <se-button id="textBtn2" option="text" color="primary"
            >Primary</se-button
          >
          <se-divider></se-divider>
          <ul>
          ...
          <se-radio-switch id="toggle-switch-el"></se-radio-switch>
          <se-divider></se-divider>
          <ul>
            <li id="radio-message">selected radio button: <span></span></li>
          </ul>
          <se-radio id="RadioGroup1" option="radio">
      ...
      <se-widget id="widget3">
        ...
        <se-widget-content>
          <se-button
            ...
            option="raised"
            >Open Dialog simple</se-button
          >
          <se-button onclick="openDialog('dialog-simple-title')" option="raised"
            >Open Dialog title & icon</se-button
          >
