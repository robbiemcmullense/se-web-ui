...
| `color`      | `color`      | Defines the color of the checkbox for when the option is set to `checkbox` or `switch`. The default value is `primary`, rendering a green color. The `secondary` setting renders a blue color.                                                                                                                   | `"primary" \| "secondary"`          | `'primary'`  |
...
| `selected`   | `selected`   | Determines whether or not the checkbox is checked when you initialize it.  Set to `false` by default.                                                                                                                                                                                                            | `boolean`                           | `false`      |
