...
| ------------ | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | ------------ |
| `background` | `background` | Defines the color of the checkbox for onoff option. The default value is `standard`.                                                                                                              | `"alternative" \| "standard"`       | `'standard'` |
...
| `header`     | `header`     | Reduce the visual height of the checkbox when the option is set to 'onoff'. Useful if the on/off checkbox is within a header element.                                                             | `boolean`                           | `false`      |
