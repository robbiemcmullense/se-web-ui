...
| `iconColor`   | `icon-color`  | Optional property to define the color of the icon. The default color will be inherited from it's parent. | `"disable" \| "error" \| "primary" \| "standard" \| "warning"` | `undefined` |
