...
| `option`      | `option`      | Define the theme of the list. This them will be handled and modified by the parent element.              | `"classic" \| "dropdown" \| "headline" \| "nav" \| "treeview"`                                 | `"classic"` |
