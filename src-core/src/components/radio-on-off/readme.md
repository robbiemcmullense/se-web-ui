...
| ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- | ------------ |
| `color`    | `color`    | Defines the background color of the button. Default is `standard`, rendering a light gray background color.                                                                                | `"alternative" \| "standard"` | `'standard'` |
...
| `textOff`  | `text-off` | Defines the text the user will see for the "off" or "inactive" part of the radio switch.  Set to `OFF` by default.                                                                         | `string`                      | `'OFF'`      |
| `textOn`   | `text-on`  | Defines the text the user will see for the "on" or "active" part of the radio switch.  Set to `ON` by default.                                                                             | `string`                      | `'ON'`       |
