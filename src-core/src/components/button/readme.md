...
| `iconOnly`  | `icon-only`  | Optional property to specify if the button contains a text or only an icon. THis will impact how the buttons render. Only necessary when using svg icon instead of the `icon` name property.                                                                                                                              | `boolean`                                                                                   | `undefined`  |
