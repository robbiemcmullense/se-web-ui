...
| `option`   | `option`   | Defines the visual appearance of a block. `basic` will remove any spacing. `card` will create a card look and feel with shadow and rounded corners. | `"basic" \| "card"`           | `"basic"`       |
