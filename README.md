...
| [x]  | container | container of widgets. Adds a margin for better widget alignment                                               | `mode`="full/widget/centered", `position`="relative/absolute" `cols`, `rowHeight` ... not quite sure                             |
