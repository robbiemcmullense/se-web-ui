...
| [x]  | Button           |                                                                                                               | `mode`="flat/raised/text/login/signup", `color`="primary/accent/warn/error", `isDisabled`="true/false", `value`="string", `icon`="string", `buttonClicked()`            |
| [ ]  | Radio            |                                                                                                               | `value`, `disabled`, `change()`                                                          |
| [ ]  | Radio-item       |                                                                                                               | `value`, `disabled`                                                                      |
| [x]  | Radio-on-off     |                                                                                                               | `mode`="default/header", `textOn`, `textOff`, `isDisabled`="true/false", `change()`                                   |
