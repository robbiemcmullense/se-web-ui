...
| [x]  | container        | page container. Can be used to add a margin for better widget alignment. Default will make the use of the full flex space. | `mode`="fill/widget/centered", `position`="relative/absolute" `cols`, `rowHeight` ... not quite sure                                                 |
| [x]  | divider          | used to add a line to divide element between each others.                                                                  | `mode`="horizontal/vertical"                                                                                                                         |
...
| [x]  | Checkbox         | checkbox to check or uncheck a value                                                                                       | `color`="primary/accent/warn/error", `disabled`="true/false", `value`="string", `change()`                                                           |
| [x]  | Chip             | "badge" icon that can be used as a notification component                                                                  | `value`="string", `canClose`="true/false", `close()`                                                                                                 |
...
| [x]  | Label            | label to be displayed next to an input field or checkbox                                                                   | `value`="string", `required`="true/false"                                                                                                            |
| [x]  | Link             | anchor element that redirects a user to another web page                                                                   | `type`="internal/external", `url`="string", `value`="string", `disabled`="true/false"                                                                |
| [ ]  | Tree             |                                                                                                                            |                                                                                                                                                      |
